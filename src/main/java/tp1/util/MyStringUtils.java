...
public class MyStringUtils {
	...
	public static String repeat(String x, int n) {
		...
		// result.repeat(x, n); //puedes reemplazar el bucle anterior por esta línea si
		// usas Java 21
	...
	/**
	 * Justica a la derecha un texto en un espacio de un determinado ancho (el resto
	 * se rellena
	 * con el carácter que se determine)
	 * 
	 * @param texto   cadena a centrar
	 * @param ancho   tamaño de la cadena resultado
	 * @param relleno carácter con el que rellenar
	 * @return Una cadena de tamaño ancho en la que texto queda justificado a la
	 *         derecha
	 */
	...
	/**
	 * Justica a la izquierda un texto en un espacio de un determinado ancho (el
	 * resto se rellena
	 * con el carácter que se determine)
	 * 
	 * @param texto   cadena a justificar a la izquierda
	...
	/**
	 * Dado un String devuelve el String formado con sus letras mayúsculas en el
	 * mismo orden.
	 * Borra todas las que no son mayúsculas.
	 * 
	 * @param str string a filtrar, not null
	 * @return Un string formado con las mayusculas en el mismo orden que las
	 *         originales.
	 */
