...
public class ConsoleColorsView extends ConsoleView {
	...
	private static final String COLOR_LAND_BACKGROUND = ConsoleColorsAnsiCodes.ANSI_RGB_BACKGROUND.formatted(218, 165,
			32); // ConsoleColorsAnsiCodes.ANSI_CYAN_BACKGROUND
	...
	private static final String EXIT_TEXT = ConsoleColorsAnsiCodes.ANSI_WHITE
			+ MyStringUtils.center(Messages.EXIT_DOOR, CELL_SIZE);
